...
Oppgavekortet under AI-bruk viser bare økter Claude og Codex selv har skrevet i samtaleloggene sine på Mac-en. Aldri fabrikker agentaktivitet eller demo-agenter: uten logger skal kortet si eksplisitt at ingenting kjører. Skill mellom «jobber», «står stille» (påbegynt tur uten hendelser på fem minutter) og «ferdig, venter på deg» — det er hele spørsmålet kortet finnes for å svare på. Vis hva økta gjør på norsk, ikke verktøynavnet fra loggen, og send aldri innholdet i samtalene til nettleseren.
